        ...
        return users.map((user, index) => {
            ...
            return (
                <tr key={index} className={index % 2 === 0 ? "light-row" : "dark-row"}>
                    <td>
                        {rank === 1 && <img src={oneSt} alt="Gold Medal" className={styles.medal} />}
                        {rank === 2 && <img src={twoSt} alt="Silver Medal" className={styles.medal} />}
                        {rank === 3 && <img src={threeSt} alt="Bronze Medal" className={styles.medal} />}
